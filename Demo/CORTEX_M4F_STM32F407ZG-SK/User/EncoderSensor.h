...
/* EncoderSensor High Pass Filter struct */
typedef struct
{
...
// #define EncoderSensor_SPI_INT1_PIN              GPIO_Pin_0                  /* PE.00 */
// #define EncoderSensor_SPI_INT1_GPIO_PORT        GPIOE                       /* GPIOE */
// #define EncoderSensor_SPI_INT1_GPIO_CLK         RCC_AHB1Periph_GPIOE
// #define EncoderSensor_SPI_INT1_EXTI_LINE        EXTI_Line0
// #define EncoderSensor_SPI_INT1_EXTI_PORT_SOURCE EXTI_PortSourceGPIOE
// #define EncoderSensor_SPI_INT1_EXTI_PIN_SOURCE  EXTI_PinSource0
// #define EncoderSensor_SPI_INT1_EXTI_IRQn        EXTI0_IRQn 

// #define EncoderSensor_SPI_INT2_PIN              GPIO_Pin_1                  /* PE.01 */
// #define EncoderSensor_SPI_INT2_GPIO_PORT        GPIOE                       /* GPIOE */
// #define EncoderSensor_SPI_INT2_GPIO_CLK         RCC_AHB1Periph_GPIOE
// #define EncoderSensor_SPI_INT2_EXTI_LINE        EXTI_Line1
// #define EncoderSensor_SPI_INT2_EXTI_PORT_SOURCE EXTI_PortSourceGPIOE
// #define EncoderSensor_SPI_INT2_EXTI_PIN_SOURCE  EXTI_PinSource1
// #define EncoderSensor_SPI_INT2_EXTI_IRQn        EXTI1_IRQn 
...
*  Default value: 0x3B
*******************************************************************************/
#define EncoderSensor_WHO_AM_I_ADDR                  0x0F
...
*         1- X axis enabled
********************************************************************************/
#define EncoderSensor_CTRL_REG1_ADDR                 0x20
...
*              11     |    0.25   |     1     |
*******************************************************************************/
#define EncoderSensor_CTRL_REG2_ADDR              0x21
...
*******************************************************************************/
#define EncoderSensor_CTRL_REG3_ADDR              0x22
...
*  Default value: Dummy
*******************************************************************************/
#define EncoderSensor_HP_FILTER_RESET_REG_ADDR     0x23
...
*******************************************************************************/
#define EncoderSensor_STATUS_REG_ADDR             0x27
...
*******************************************************************************/
#define EncoderSensor_OUT_X_ADDR                  0x29
...
*******************************************************************************/
#define EncoderSensor_OUT_Y_ADDR                  0x2B
...
*******************************************************************************/
#define EncoderSensor_OUT_Z_ADDR                  0x2D
...
*          1: enable interrupt request on measured accel. value lower than preset threshold
*******************************************************************************/
#define EncoderSensor_FF_WU_CFG1_REG_ADDR         0x30
...
*******************************************************************************/
#define EncoderSensor_FF_WU_SRC1_REG_ADDR           0x31
...
*******************************************************************************/
#define EncoderSensor_FF_WU_THS1_REG_ADDR          0x32
 ...
 ******************************************************************************/
#define EncoderSensor_FF_WU_DURATION1_REG_ADDR     0x33
...
*          1: enable interrupt request on measured accel. value lower than preset threshold
*******************************************************************************/
#define EncoderSensor_FF_WU_CFG2_REG_ADDR         0x34
...
*        1: XL event has occurred
*******************************************************************************/
#define EncoderSensor_FF_WU_SRC2_REG_ADDR           0x35
...
*  6 THS6-THS0: Free-fall/wake-up threshold value.
*******************************************************************************/
#define EncoderSensor_FF_WU_THS2_REG_ADDR          0x36
...
*  7:0 D7-D0 Duration value. (Duration steps and maximum values depend on the ODR chosen)
 ******************************************************************************/
#define EncoderSensor_FF_WU_DURATION2_REG_ADDR     0x37
...
*              1: enable interrupt request
 ******************************************************************************/
#define EncoderSensor_CLICK_CFG_REG_ADDR     0x38
...
*******************************************************************************/
#define EncoderSensor_CLICK_SRC_REG_ADDR        0x39
...
*******************************************************************************/
#define EncoderSensor_CLICK_THSY_X_REG_ADDR        0x3B
...
*******************************************************************************/
#define EncoderSensor_CLICK_THSZ_REG_ADDR         0x3C
...
*******************************************************************************/
#define EncoderSensor_CLICK_TIMELIMIT_REG_ADDR        0x3D
...
*******************************************************************************/
#define EncoderSensor_CLICK_LATENCY_REG_ADDR        0x3E
...
*******************************************************************************/
#define EncoderSensor_CLICK_WINDOW_REG_ADDR        0x3F

/******************************************************************************/
/**************************** END REGISTER MAPPING  ***************************/
/******************************************************************************/

#define EncoderSensor_SENSITIVITY_2_3G                         18  /* 18 mg/digit*/
#define EncoderSensor_SENSITIVITY_9_2G                         72  /* 72 mg/digit*/

/** @defgroup Data_Rate_selection                 
  * @{
  */
#define EncoderSensor_DATARATE_100                             ((uint8_t)0x00)
#define EncoderSensor_DATARATE_400                             ((uint8_t)0x80)
/**
  * @}
  */
...
/** @defgroup Power_Mode_selection 
  * @{
  */
#define EncoderSensor_LOWPOWERMODE_POWERDOWN                   ((uint8_t)0x00)
#define EncoderSensor_LOWPOWERMODE_ACTIVE                      ((uint8_t)0x40)
/**
  * @}
  */
...
/** @defgroup Full_Scale_selection 
  * @{
  */
#define EncoderSensor_FULLSCALE_2_3                            ((uint8_t)0x00)
#define EncoderSensor_FULLSCALE_9_2                            ((uint8_t)0x20)
/**
  * @}
  */
...
/** @defgroup Self_Test_selection 
  * @{
  */
#define EncoderSensor_SELFTEST_NORMAL                          ((uint8_t)0x00)
#define EncoderSensor_SELFTEST_P                               ((uint8_t)0x10)
#define EncoderSensor_SELFTEST_M                               ((uint8_t)0x08)
/**
  * @}
  */  
...
/** @defgroup Direction_XYZ_selection 
  * @{
  */
#define EncoderSensor_X_ENABLE                                 ((uint8_t)0x01)
#define EncoderSensor_Y_ENABLE                                 ((uint8_t)0x02)
#define EncoderSensor_Z_ENABLE                                 ((uint8_t)0x04)
#define EncoderSensor_XYZ_ENABLE                               ((uint8_t)0x07)
/**
  * @}
  */
  ...
  * @{
  */
#define EncoderSensor_SERIALINTERFACE_4WIRE                    ((uint8_t)0x00)
#define EncoderSensor_SERIALINTERFACE_3WIRE                    ((uint8_t)0x80)
/**
  * @}
  */ 
  ...
  * @{
  */
#define EncoderSensor_BOOT_NORMALMODE                          ((uint8_t)0x00)
#define EncoderSensor_BOOT_REBOOTMEMORY                        ((uint8_t)0x40)
/**
  * @}
  */   
  ...
  * @{
  */
#define EncoderSensor_FILTEREDDATASELECTION_BYPASSED           ((uint8_t)0x00)
#define EncoderSensor_FILTEREDDATASELECTION_OUTPUTREGISTER     ((uint8_t)0x20)
/**
  * @}
  */ 
  ...
  * @{
  */  
#define EncoderSensor_HIGHPASSFILTERINTERRUPT_OFF              ((uint8_t)0x00)
#define EncoderSensor_HIGHPASSFILTERINTERRUPT_1                ((uint8_t)0x04)
#define EncoderSensor_HIGHPASSFILTERINTERRUPT_2                ((uint8_t)0x08)
#define EncoderSensor_HIGHPASSFILTERINTERRUPT_1_2              ((uint8_t)0x0C)
/**
  * @}
  */ 
  ...
  * @{
  */
#define EncoderSensor_HIGHPASSFILTER_LEVEL_0                   ((uint8_t)0x00)
#define EncoderSensor_HIGHPASSFILTER_LEVEL_1                   ((uint8_t)0x01)
#define EncoderSensor_HIGHPASSFILTER_LEVEL_2                   ((uint8_t)0x02)
#define EncoderSensor_HIGHPASSFILTER_LEVEL_3                   ((uint8_t)0x03)
/**
  * @}
  */
...
/** @defgroup latch_Interrupt_Request_selection 
  * @{
  */
#define EncoderSensor_INTERRUPTREQUEST_NOTLATCHED              ((uint8_t)0x00)
#define EncoderSensor_INTERRUPTREQUEST_LATCHED                 ((uint8_t)0x40)
/**
  * @}
  */
...
/** @defgroup Click_Interrupt_XYZ_selection 
  * @{
  */
#define EncoderSensor_CLICKINTERRUPT_XYZ_DISABLE               ((uint8_t)0x00)
#define EncoderSensor_CLICKINTERRUPT_X_ENABLE                  ((uint8_t)0x01)
#define EncoderSensor_CLICKINTERRUPT_Y_ENABLE                  ((uint8_t)0x04)
#define EncoderSensor_CLICKINTERRUPT_Z_ENABLE                  ((uint8_t)0x10)
#define EncoderSensor_CLICKINTERRUPT_XYZ_ENABLE                ((uint8_t)0x15)
/**
  * @}
  */
...
/** @defgroup Double_Click_Interrupt_XYZ_selection 
  * @{
  */
#define EncoderSensor_DOUBLECLICKINTERRUPT_XYZ_DISABLE         ((uint8_t)0x00)
#define EncoderSensor_DOUBLECLICKINTERRUPT_X_ENABLE            ((uint8_t)0x02)
#define EncoderSensor_DOUBLECLICKINTERRUPT_Y_ENABLE            ((uint8_t)0x08)
#define EncoderSensor_DOUBLECLICKINTERRUPT_Z_ENABLE            ((uint8_t)0x20)
#define EncoderSensor_DOUBLECLICKINTERRUPT_XYZ_ENABLE          ((uint8_t)0x2A)
/**
  * @}
  */
/**
...
void EncoderSensor_InterruptConfig(EncoderSensor_InterruptConfigTypeDef *EncoderSensor_InterruptConfigStruct);
void EncoderSensor_FilterConfig(EncoderSensor_FilterConfigTypeDef *EncoderSensor_FilterConfigStruct);
void EncoderSensor_LowpowerCmd(uint8_t LowPowerMode);
void EncoderSensor_FullScaleCmd(uint8_t FS_value);
void EncoderSensor_DataRateCmd(uint8_t DataRateValue);
void EncoderSensor_RebootCmd(void);
void EncoderSensor_ReadACC(int32_t* out);
void EncoderSensor_Write(uint8_t* pBuffer, uint8_t WriteAddr, uint16_t NumByteToWrite);
